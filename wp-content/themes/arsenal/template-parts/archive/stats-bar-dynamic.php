...
// Получаем ID команды Арсенал (по team_id из новой структуры)
...
if ( $arsenal_team_id ) {
	...
	$standings = arsenal_calculate_standings( null, $tournament_id );
	
	// 1. Находим позицию Арсенала в турнирной таблице
	$position = '—';
	$arsenal_stats = null;
	...
	// 2. Количество игроков с активными контрактами на сегодня
