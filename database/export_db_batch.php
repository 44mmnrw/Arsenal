<?php
/**
 * Экспорт таблиц Arsenal с разделением на батчи
 */
require_once dirname(__DIR__) . '/wp-load.php';

global $wpdb;

$output_file = dirname(__DIR__) . '/database/arsenal_batch_dump_' . date('Y-m-d_H-i-s') . '.sql';
...
foreach ($tables as $table) {
    ...
    // Получаем данные батчами по 1000 строк
    $offset = 0;
    $batch_size = 1000;
    $total_rows = 0;
