...
class Arsenal_Menu_Manager {
    ...
    public function register() {
        ...
        // После успешного импорта скрываем пункт из меню, но страница остаётся доступной по прямой ссылке.
        $import_parent = get_option( Arsenal_Db_Import_Admin::DONE_OPTION, false ) ? '' : $slug;
        add_submenu_page( $import_parent, 'Импорт данных', 'Импорт данных', 'manage_options',
